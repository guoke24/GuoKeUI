...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    protected void onScrollTouchedUp() {
        ...
        View itm;
        //PALog.e(LOG_TAG, " ----- layout: " + mItemsLayout.getMeasuredWidth() + mItemsLayout.getMeasuredHeight());
        //PALog.e(LOG_TAG, " -------- dumping " + cnt + " items");
        for (int i = 0; i < cnt; i++) {
            itm = mItemsLayout.getChildAt(i);
            //PALog.e(LOG_TAG, " item #" + i + ": " + itm.getWidth() + "x" + itm.getHeight());
            itm.forceLayout(); // forcing layout without re-rendering parent
        }
        //PALog.e(LOG_TAG, " ---------- dumping finished ");
    }
