package com.guohao.guokeui.hencoder.hencoderpracticedraw6;
...
public class HenCoderPractive6Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale, R.string.title_scale_xy, R.layout.practice_scale));
