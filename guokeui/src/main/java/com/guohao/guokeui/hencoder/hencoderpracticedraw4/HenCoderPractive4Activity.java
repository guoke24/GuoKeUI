...
public class HenCoderPractive4Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.practice_flipboard, R.string.title_flipboard, R.layout.sample_flipboard));
    }
