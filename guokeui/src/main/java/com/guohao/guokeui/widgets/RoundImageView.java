 ...
 * 使用举例：
 *         <RoundImageView
 *             android:id="@+id/biz_me_logo"
 *             android:layout_width="wrap_content"
 *             android:layout_height="wrap_content"
 *             android:background="@drawable/biz_base_shape_round_rect_white_solid"
 *             android:src="@drawable/biz_base_ic_logo"/>
 */
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs) {
        ...
        type = a.getInt(
                R.styleable.RoundImageView_image_type,
                TYPE_ROUND // 默认为圆角
                );
    ...
    private void setUpShader() {
        Drawable drawable = getDrawable(); // xml布局文件中，android:src="@drawable/xxx" 设置的资源
        if (drawable == null) {
            return;
        }
